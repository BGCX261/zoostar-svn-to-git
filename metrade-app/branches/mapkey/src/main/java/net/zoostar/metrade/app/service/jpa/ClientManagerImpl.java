...
import static net.zoostar.metrade.app.constants.Constants.CLIENT_CACHE;
...
public class ClientManagerImpl extends AbstractJpaImpl<Client> implements ClientManager {
	...
	@Override
	public ClientVO remove(Long clientId) {
		Client client = getEntityManager().find(Client.class, clientId);
	...
	@Override
	@CacheEvict(value=CLIENT_CACHE, allEntries=true, beforeInvocation=true)
	@Transactional(propagation=Propagation.NEVER)
	public void clearCache() {
		log.warn("Cleared cache: " + CLIENT_CACHE);
	}
}
